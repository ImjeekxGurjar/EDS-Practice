...
export default async function decorate(block) {
  ...
  if (!videoLink) {
    ...
    const videoSrc = "https://www.volvotrucks.us/all-new-vnl/Videos/the-race-hero-recut.mp4"; // Your new video source
    const video = createVideo(videoSrc, `${blockName}__video`, {
      muted: true,
      autoplay: true,
      loop: true,
      playsinline: true,
